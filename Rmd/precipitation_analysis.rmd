...
```{r}
folder_url <- "https://data.ceda.ac.uk/badc/ukmo-midas-open/data/uk-hourly-rain-obs/dataset-version-202107/kent/00744_east-malling/qc-version-1/"

file_name <- "midas-open_uk-hourly-rain-obs_dv-202107_kent_00744_east-malling_qcv-1_2000.csv"

url <- "https://dap.ceda.ac.uk/badc/ukmo-midas-open/data/uk-hourly-rain-obs/dataset-version-202107/kent/00744_east-malling/qc-version-1/midas-open_uk-hourly-rain-obs_dv-202107_kent_00744_east-malling_qcv-1_2000.csv?download=1"

url <- paste0(folder_url, file_name)
...
files <- lapply(years, function(year) here(data_folder, 
                                           paste0(file_prefix, year, ".csv")))
...
ggplot(monthly, aes(x = month, y = prcpMean)) + 
    ...
    labs(x = "Month", y = "Mean precipitation (mm/day)", 
         title = "Mean daily precipitation per month") +
...
ggplot(rainEvents, aes(x = month, y = rainPerc)) + 
    ...
    stat_summary(geom = "line", fun = mean, linetype = "dashed") +
    stat_summary(geom = "point", fun = mean, color = "red") +
    labs(x = "Month", y = "% of rainy days", title = "% of rainy days per month") +
    scale_x_discrete(limits = month.abb) + 
    theme_classic2()
