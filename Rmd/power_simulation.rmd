...
tic(paste(nrow(data), "simulations of", iterations, "iterations"))
...
ggplot(powers, aes(effect, power, group = rate, 
    ...
    scale_color_viridis_d(name = "infectionRate") +
    theme_bw() + 
